...
# Sidebar
with st.sidebar:
    st.title("📦 Clase 1: Classes")
    st.markdown("""
    ### Objetivos:
    1. Entender qué es una clase
    2. Crear atributos
    ...
    st.page_link("pages/01_Introduccion.py", label="⬅️ Anterior")
    st.page_link("pages/03_Clase_Metodos.py", label="➡️ Siguiente")
